...
const InputForm = ({ name, register, type, placeholder, errors, margin }) => (
    <div className='flex justify-center'>
      ...
      <input
        type={type}
        className={`input focus:outline-none w-4/5 max-w-xs bg-transparent  border-b-4 border-amber-200 rounded-none border-l-0 border-r-0 border-t-0 placeholder-slate-100 ${margin}`}
