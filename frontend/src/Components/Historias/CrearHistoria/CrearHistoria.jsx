...
const CrearHistoria = () => {
 /*  const cambioDeInput = useRef()
  ...
  const storeElements = (e) => {
    ...
    axios.post(`http://localhost:3001/api/v1/uploads/history/${userData._id}`, formData)
    .then((res) => {
      console.log(res)
    })
    .catch((error) => {
  ...
  return (
    <div>
      ...
      <input multiple type="file" className="hidden" ref={cambioDeInput} onChange={storeElements} />
