...
const SignIn = () => {
  ...
  return (
    <form
      className="flex flex-col justify-center align-center w-full mt-10"
    ...
    >
      ...
      <button className="btn btn-lg bg-violet-700 w-2/3 mx-auto mt-14 rounded-full text-slate-100 hover-bg-violet-600">
        Sign In
      </button>
      ...
      {peticionErronea && (
        <div className="toast toast-start w-1/3">
          <div className="alert alert-error flex ">
            ...
            <span>
              El correo o la contraseña no coinciden con ninguna cuenta de
              usuario
            </span>
          </div>
        </div>
