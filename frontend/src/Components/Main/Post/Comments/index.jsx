    ...
    >
      <div className="modal-content bg-white h-5/6 mx-auto my-8 border border-gray-300 rounded-lg p-4 w-4/5 dark:bg-neutral-900">
        <div className="w-full flex ">
          <h3 className="text-2xl font-semibold mb-4 dark:text-slate-200">
            Comentarios
          </h3>
          <ion-icon
            name="close-outline"
          ...
          {completeComments ? (
            <div>
              {Object.values(completeComments).map((element, index) => (
                <div
                  key={index}
                  className="w-5/6 my-2 flex flex-col justify-start"
                >
                  <div className="flex">
                    <div className="w-1/12">
                      <Avatar
                        imageUrl={element.photoProfile}
                        marginTop={'w-14'}
                      />
                    </div>
                  ...
                  <div className="bg-sky-100 h-16 rounded-xl dark:bg-neutral-600">
                    <p className="text-left ml-5 my-2 dark:text-slate-200">
                      {element.text}
                    </p>
                  </div>
                </div>
